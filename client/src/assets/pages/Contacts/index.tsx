...
export function Contacts() {
    ...
    const addressOrganization = 'Теритариальное расположение: Тамбовская область, г. Моршанск. Работаем по всей России ';
    const hrefOnMapAddress = `https://yandex.ru/map-widget/v1/?um=constructor%3A06848f010720ab40bf3618042ab71529590e8804f966c88fa07f1228c88e095c&amp;source=constructor`;
// <iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3A06848f010720ab40bf3618042ab71529590e8804f966c88fa07f1228c88e095c&amp;source=constructor" width="100%" height="400" frameborder="0"></iframe>
    return (
        <>
