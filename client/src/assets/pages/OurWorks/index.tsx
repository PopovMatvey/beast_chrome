            ...
            <div className="out-works-container">
                ...
                <div className="out-works-container_beginner-screen_portfolio">
                    ...
                    <div className="out-works-container_beginner-screen_portfolio_contaiiner_videos">
                        <VideoSlider items={['http://matyhape.beget.tech/assets/videos/Sirius_Pro.mp4',
                            'http://matyhape.beget.tech/assets/videos/helmet.mp4',
                            'http://matyhape.beget.tech/assets/videos/flower.mp4',
                            'http://matyhape.beget.tech/assets/videos/shoe.mp4',
                            'http://matyhape.beget.tech/assets/videos/wheel_rim.mp4']} />
                    </div>
                </div>
            </div>
        </>
